    ...
    <main className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-16 px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        ...
        <div className="md:col-span-3 space-y-8">
          ...
          <div className="text-left">
            <div className="flex -space-x-3 mb-2">
              {/* Simple outlined avatars */}
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="w-10 h-10 rounded-full border-2 border-gray-500 bg-gray-700"/>
              ))}
            </div>
            <p className="font-bold text-white">150+ Reviews (4.9 of 5)</p>
        ...
        <div className="md:col-span-6 flex flex-col items-center text-center">
          <p className="font-semibold text-gray-300 mb-4">Hello There!</p>
          ...
          <div className="relative mt-8">
            ...
            />
            {/* CTA Buttons */}
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 z-20 flex items-center bg-gray-900/50 backdrop-blur-sm border border-gray-600 rounded-full p-1.5">
              <button className="bg-white text-black py-2 px-6 rounded-full flex items-center gap-2">
        ...
        <div className="md:col-span-3 flex flex-col items-end space-y-16">
          {/* Skills Tags - all use the same subtle color */}
          <div className="flex flex-wrap justify-end gap-3">
            <span className="bg-accent-dark text-gray-300 text-sm font-semibold px-4 py-2 rounded-full">Prototype</span>
            <span className="bg-accent-dark text-gray-300 text-sm font-semibold px-4 py-2 rounded-full">Dashboard</span>
            <div className="w-full flex justify-end items-center gap-2">
              <Plus size={16} className="text-gray-400"/>
              <span className="bg-accent-dark text-gray-300 text-sm font-semibold px-4 py-2 rounded-full">Mobile App Design</span>
            </div>
            <span className="bg-accent-dark text-gray-300 text-sm font-semibold px-4 py-2 rounded-full">Design System</span>
            <span className="bg-accent-dark text-gray-300 text-sm font-semibold px-4 py-2 rounded-full">Website Design</span>
          </div>
      ...
      <div className="absolute top-32 right-16 w-32 h-32 hidden lg:block">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="bg-gray-700 text-white w-8 h-8 rounded-full flex items-center justify-center">
